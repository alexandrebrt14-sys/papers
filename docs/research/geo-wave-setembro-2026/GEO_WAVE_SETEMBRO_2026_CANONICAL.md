...
> Nota de precedência, 10/09/2026: a [integração de setembro-10](../geo-wave-setembro-10-2026/GEO_WAVE_SETEMBRO_10_2026_CANONICAL.md) atualiza conceitos, limitações das métricas locais e desenho do Paper 2. Em conflito conceitual, consultar essa integração e a seção 13 da metodologia v2. O corpo desta onda permanece como registro histórico; recomendações de convergência para monitoramento não substituem retroativamente a regra confirmatória da série.
